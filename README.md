...
| 路由 | 页面 | 说明 |
| --- | --- | --- |
| `/market-sales` | 市场销量 | 总体销量趋势、月度明细、季度聚合、年度汇总，多维筛选支持零售/产量与全部/新能源/纯电 |
| `/brand-sales` | 品牌销量 | 品牌选择与最多 3 品牌对比，支持零售/产量和月度/季度/年度粒度 |
| `/data-analysis/nev` | NEV 覆盖率 | 新能源渗透率、纯电占新能源比例 |
| `/data-analysis/origin` | 车系占比 | 国别/车系份额趋势 |
